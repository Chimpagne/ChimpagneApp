...
class EventsViewModel(eventID: String? = null) : ViewModel() {
    ...
    private fun fetchEvent(id: String, onSuccess: () -> Unit = {}, onFailure: (Exception) -> Unit = {}){
    ...
    fun addGuestToTheEvent(guestId: String, onSuccess: () -> Unit = {}, onFailure: (Exception) -> Unit = {}){
        viewModelScope.launch {
    ...
    fun removeGuestFromTheEvent(guestId: String, onSuccess: () -> Unit = {}, onFailure: (Exception) -> Unit = {}){
        viewModelScope.launch {
