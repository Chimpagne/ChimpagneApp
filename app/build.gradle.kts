...
sonar {
    properties {
        ...
        // Adjust the path to point to your line coverage report generated by JaCoCo
        property("sonar.coverage.jacoco.xmlReportPaths", "${project.layout.buildDirectory.get()}/reports/jacoco/lineCoverage/jacocoTestReport.xml")
    }
}
